...
type alias HighscoreStatus = { jouw : Maybe (Spelduur, Int), huidig : Spelduur, alle : Dict.Dict Int (List (String, Int)), oauth : String, muziek : Adios }
...
viewHighscore info = div 
  ...
  , onClick Submit
    ...
    Utils.rows 
      ...
      , (30, [], cols
        [ (37, [])
        , (20, let content = case info.jouw of
                                Nothing -> []
                                Just (d,p) -> [text ("Jouw score: " ++ String.fromInt p)]
               in [div [style "text-align" "center"] content])
        , (43, [])
        ])
      ])
